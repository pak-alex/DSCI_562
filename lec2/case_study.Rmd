...
Expit interpretation: Increasing the X by one in Odds(Y|X=x) will increase the odds by exp(B1)
We're making assumptions about the distribution AT Y | X = x (ie Y|X=x ~ Bernoulli())
Called GLM because you always have the general form B0 + B1x, then apply a link function (and sometimes make assumptions about the distribution) 
